...
```
Una closure è una funzione che restituisce a sua volta una funzione `innerFunction`, in questo caso la innerFunction, accetterà un parametro che sarà il nome da salutare.